...
def med33(img):
    ...
    for i in range(1,row+1,1):
        for j in range(1,col+1,1):
            ...
            retMatrix[i-1][j-1]=np.median(tmp)            
    return retMatrix
...
def med55(img):
    ...
    for i in range(2,row+2,1):
        for j in range(2,col+2,1):
            ...
            retMatrix[i-2][j-2]=np.median(tmp)
    return retMatrix
...
im3.show()
im3=im3.convert("L")
im3.save('lena_sap0.1_med33.bmp',format='BMP')
...
im3.show()
im3=im3.convert("L")
im3.save('lena_sap0.1_med55.bmp',format='BMP')
...
im4.show()
im4=im4.convert("L")
im4.save('lena_sap0.0.5_med33.bmp',format='BMP')
...
im4.show()
im4=im4.convert("L")
im4.save('lena_sap0.0.5_med55.bmp',format='BMP')